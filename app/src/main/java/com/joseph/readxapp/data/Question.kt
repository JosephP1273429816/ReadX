    ...
    init {
        ...
        questionList.add(
            Question(
                ...
                "La Justicia es en primer lugar una cualidad posible, pero no necesaria, de un orden social que regula las relaciones mutuas entre los hombres. Sólo secundariamente es una virtud humana, ya que un hombre es justo solo si su conducta se adecúa a las normas de un orden social supuestamente justo. Pero, ¿qué significa decir que un orden social es justo? Significa que este orden social regula la conducta de los hombres de un modo satisfactorio para todos, es decir, que todos los hombres encuentran en él la felicidad. La búsqueda de la Justicia es la eterna búsqueda de la felicidad humana. Es una finalidad que el hombre no puede encontrar por sí mismo y por ello la busca en la sociedad. La Justicia es la felicidad social, garantizada por un orden social. Platón, identificando la Justicia con la felicidad, sostiene que un hombre justo es feliz y un hombre injusto es infeliz. Evidentemente, la afirmación según la cual la Justicia es la felicidad no es una respuesta definitiva, sino una forma de eludir el problema. Pues inmediatamente se plantea la cuestión: '¿Qué es la felicidad?'.\n" +
                        "\n" +
        ...
        questionList.add(
            Question(
                ...
                "Franz Kafka: Existen métodos insuficientes, casi pueriles, que también pueden servir para la salvación. He aquí la prueba:\n" +
                        "\n" +
        ...
        questionList.add(
            Question(
                ...
                "ARTE POÉTICA\n" +
                        ...
                        "\n" +
                        "La poesía vuelve como la aurora\n" +
                        "y el ocaso. A veces en las tardes\n" +
                        "una cara nos mira desde el fondo\n" +
                        "de un espejo; el arte debe ser como ese espejo\n" +
        ...
        questionList.add(
            Question(
                ...
                "EL CONSUMIDOR DEL “AJUSTE”\n" +
                        ...
                        "\n" +
                        "Ese nuevo consumidor socializado exige y escoge con mayor libertad e inteligencia, es una mezcla de convicción, impulso de compra y reflexión; su compra está determinada por las percepciones, las representaciones y los valores que conforman su estilo de vida, su ámbito privado y este en razón de su pertenencia a un grupo que legitima su actuar.\n" +
                        "\n" +
                        "Bien decía Mattelart que “la era de la mencionada sociedad de la información es también la de la producción de estados mentales”. Y es que este consumidor, compra y consume de acuerdo con su estado mental. Por eso, cada día con más fuerza, es necesario alcanzar a este consumidor en su cotidianidad y sorprenderlo no solo con la fuerza del mensaje sino con la novedad del medio: altas dosis de sorpresa y sentido de oportunidad.\n" +
                        "\n" +
